...
const Staking = lazy(() =>
    import(/* webpackChunkName: 'admin.staking' */ "./pages/staking")
);
...
const Verification = lazy(() =>
    import(/* webpackChunkName: 'admin.verification' */ "./pages/verification")
);
...
const Admin = () => {
    ...
    return (
        <Routes>
            ...
            <Route
                path={router.getRoutePath("admin.staking")}
                element={
                    <Middleware rules={can("manage_stakes")}>
                        <Staking />
                    </Middleware>
                }
            />
            ...
            <Route
                path={router.getRoutePath("admin.verification")}
                element={
                    <Middleware rules={can("manage_settings")}>
                        <Verification />
                    </Middleware>
