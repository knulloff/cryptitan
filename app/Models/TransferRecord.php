...
class TransferRecord extends Model
{
    ...
    {
        return coin($this->getAttributeFromArray('value'), $this->walletAccount->wallet->coin);
    }
    ...
    {
        return coin($this->getAttributeFromArray('balance') ?: 0, $this->walletAccount->wallet->coin);
    }
