...
class ExchangeTrade extends Model
{
    ...
    {
        return new Money($this->getAttributeFromArray('payment_value'), new Currency($this->paymentAccount->currency));
    }
    ...
    {
        return coin($this->getAttributeFromArray('fee_value'), $this->walletAccount->wallet->coin);
    }
    ...
    {
        return coin($this->getAttributeFromArray('wallet_value'), $this->walletAccount->wallet->coin);
    }
